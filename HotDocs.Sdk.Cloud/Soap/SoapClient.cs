...
namespace HotDocs.Sdk.Cloud.Soap
{
    ...
    public class SoapClient : ClientBase, IDisposable
    {
            ...
            : base(subscriberId, signingKey, hostAddress, "Core.svc", proxyServerAddress)
        {
            ...
            if (!string.IsNullOrEmpty(proxyServerAddress))
            {
                ...
                var transport =
                    (HttpTransportBindingElement) binding.Elements.Single(e => e is HttpTransportBindingElement);
    ...
    // For debug builds, allow invalid server certificates.
            ...
            bool uploadPackage)
        {
            ...
            var settingsDict = new Dictionary<string, string>(settings.Settings);
            ...
            return _proxy.GetInterview(
                ...
                GetBinaryObjectArrayFromString(answers),
                settings.Format,
                settings.MarkedVariables.ToArray(),
                interviewImageUrl,
                settingsDict,
                billingRef,
                timestamp,
        ...
        /// </summary>
        /// <param name="answers">
        ///     An array of answers as binary objects, which will be overlayed successively to produce a single
        ///     <c>BinaryObject</c>.
        /// </param>
        /// <param name="billingRef">
        ///     This parameter lets you specify information that will be included in usage logs for this call.
