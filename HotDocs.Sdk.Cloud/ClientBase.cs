...
namespace HotDocs.Sdk.Cloud
{
    ...
    public abstract class ClientBase
    {
        ...
        /// </param>
        /// <returns>
        ///     An <c>AssemblyResult</c>, which contains the assembled documents, pending assemblies, and unanswered variables
        ///     from the assembly.
        /// </returns>
        public AssemblyResult AssembleDocument(Template template, string answers = null,
            AssembleDocumentSettings settings = null, string billingRef = null)
        {
        ...
        /// </param>
        /// <returns>
        ///     An <c>BinaryObject</c> array, which contains the HTML fragment and any dialog element images required by the
        ///     requested interview.
        /// </returns>
        public BinaryObject[] GetInterview(Template template, string answers = null, InterviewSettings settings = null,
        ...
        protected internal BinaryObject GetPackageIfNeeded(PackageTemplateLocation location, bool uploadPackage)
        {
            ...
            using (var stream = location.GetPackageStream())
            {
                byte[] data;
                if (stream.CanSeek)
                {
