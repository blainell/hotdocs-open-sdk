...
namespace HotDocs.Sdk.Server
{
    ...
    public class InterviewWorkItem : WorkItem
    {
        ...
        /// </summary>
        /// <param name="options">
        ///     The InterviewOptions to use for this interview.  This parameter makes the WorkSession's
        ///     DefaultInterviewOptions redundant/useless. TODO: We need to decide whether to use a parameter, or only the
        ///     defaults.
        /// </param>
        /// <returns></returns>
        public InterviewResult GetInterview(InterviewOptions options)
        {
