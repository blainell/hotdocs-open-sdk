...
namespace HotDocs.Sdk.Server
{
    ...
    public class AssembleDocumentResult : IDisposable
    {
        ...
        /// <param name="answers">
        ///     The answers after the assembly has finished. (Depending on template scripting, the answers may be
        ///     different at the end of the assembly than at the start.)
        /// </param>
        ...
        internal AssembleDocumentResult(Document document, string answers, IEnumerable<Template> pendingAssemblies,
            IEnumerable<string> unansweredVariables)
        {
            Document = document;
            if (answers != null)
                Answers = answers;
        ...
        /// </summary>
        public IEnumerable<Template> PendingAssemblies { get; }
        ...
        public int PendingAssembliesCount
        {
            get
            {
                if (PendingAssemblies == null)
                    return 0;
                return PendingAssemblies.Count();
            }
        }
