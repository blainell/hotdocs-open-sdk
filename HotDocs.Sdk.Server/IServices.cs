...
{
    /// <summary>
    ///     This is a stateless, object-oriented interface for basic communications with HotDocs Server or Cloud Services,
    ///     including
    ...
    ///         <item>
    ///             <c>WebService.Services</c> - talks to a remotely-running copy of HotDocs Server via the HotDocs Server
    ...
    public interface IServices
    {
        ...
        InterviewResult GetInterview(Template template, TextReader answers, InterviewSettings settings,
        ...
        AssembleDocumentResult AssembleDocument(Template template, TextReader answers, AssembleDocumentSettings settings,
            string logRef);
        ...
        void BuildSupportFiles(Template template, HdSupportFilesBuild flags);
