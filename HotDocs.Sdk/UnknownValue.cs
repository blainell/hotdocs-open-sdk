...
{
    /// <summary>
    ///     The UnknownValue struct is used to represent unrecognized values in HotDocs. This would include values that have
    ///     somehow found their
    ...
    {
        private readonly string _outerXml;
        // XML fragment for unknown value (typically either a DBValue, ClauseLibValue, or DocTextValue)
