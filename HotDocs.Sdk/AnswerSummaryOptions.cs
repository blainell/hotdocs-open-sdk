...
{
	public enum BorderType { Default, None, Plain, Sculpted }
	public enum AnswerSummaryFormat { Default, OneColumn, TwoColumns }
	...
	/// <list type="number">
	/// <item><description>they're very specialized;</description></item>
	/// <item><description>they are all irrelevant if the host application disables answer summaries; and</description></item>
	/// <item><description>at some point in the future, answer summaries may be dealt with independently of interviews.</description></item>
	/// </list>
	/// </summary>
	public class AnswerSummaryOptions
	{
		...
		/// </summary>
		public AnswerSummaryOptions() : this(AnswerSummaryOptions.Default)
		{
		}
		...
		private AnswerSummaryOptions(bool readDefaults)
		{
			if (readDefaults)
			{
				...
				Format = Util.ReadConfigurationEnum<AnswerSummaryFormat>("AnswerSummaryFormat", AnswerSummaryFormat.Default);
				Border = Util.ReadConfigurationEnum<BorderType>("AnswerSummaryBorderType", BorderType.Default);
