...
namespace HotDocs.Sdk
{
    ...
    public static class InterviewResponse
    {
        ...
        public static string GetAnswers(NameValueCollection form)
        {
            ...
            var hdInfoValues = form.GetValues("HDInfo");
        ...
        public static Stream GetAnswerStream(NameValueCollection form)
        {
            return new MemoryStream(Encoding.UTF8.GetBytes(GetAnswers(form)));
        }
    }
}