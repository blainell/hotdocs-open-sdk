...
namespace HotDocs.Sdk
{
    ...
    public class Dependency : IEquatable<Dependency>, IComparable<Dependency>
    {
        ...
        /// <summary>
        ///     A file system folder that suggests where in the local file system the dependency may be found. For internal use
        ///     only.
        /// </summary>
        ...
        private string Key
        {
            get
            {
                if (_key == null)
                {
                    _key = (FileName != null ? FileName.ToLower() : string.Empty) + "|" +
                           (HintPath != null ? HintPath.ToLower() : string.Empty) + "|" + DependencyType;
                }
                return _key;
            }
        }
        ...
        /// <returns>
        ///     Zero if both dependecies are equal. Less than zero if the current dependency is less than the other dpendency.
        ///     Greater than zero if the current dependency is greater than the other dpendency
        /// </returns>
