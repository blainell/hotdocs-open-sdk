...
namespace HotDocs.Sdk
{
    ...
    public class AssembleDocumentSettings : Settings
    {
        ...
        private AssembleDocumentSettings(bool readDefaults)
        {
            ...
            DateOrderPreference = Util.ReadConfigurationEnum("DateOrder", DateOrder.Default);
        ...
        ///     <para>
        ///         This property initializes to "Native" by default, which means a document will be generated
        ///         in the format native to whichever template is used.
        ///     </para>
        ...
        /// </summary>
        /// <remarks>
        ///     This property corresponds to the "Assemble marked-up documents" setting in the HotDocs
        ///     Server management console, the AssembleMarkupDocument property in the HotDocs Server .NET API,
        ///     and the AssembleMarkedDocuments setting in Cloud Services.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        ///     Setting this to True corresponds to the behavior of desktop HotDocs, where template
        ///     authors can override the user-selected default Unanswered format.
        /// </remarks>
        ...
        ///                 Dictates what to merge (by default) when a value for which no answer is available is merged into
        ///                 document text.
        ...
        ///             <description>
        ///                 (number of seconds) By default, HotDocs Cloud Services will assume a request to assemble a document has
        ///                 hung if the
        ///                 response takes longer than (a certain time). Setting RequestTimeout to another value can raise or lower
        ///                 the
        ///                 threshhold before HotDocs gives up on a request. For performance reasons, HotDocs Cloud Services may
        ///                 ignore
        ///                 values over a certain threshhold.
        ///             </description>
        ///         </item>
        ///         <item>
        ...
        ///                 For performance reasons, HotDocs Cloud Services may ignore values over a certain threshhold.
        ///             </description>
        ///         </item>
        ///         <item>
        ...
        ///         </item>
        ///         <item>
        ///             <term>AssembleMarkedDocuments</term>
        ///             <description>
        ///                 "true" or "false"<br />
        ///                 Dictates whether this document will be assembled traditionally ("false") or using markup view ("true").
        ///             </description>
