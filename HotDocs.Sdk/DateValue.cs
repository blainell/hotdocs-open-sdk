...
namespace HotDocs.Sdk
{
    ...
    ///     with value semantics. Instances of DateValue directly contain the relevant date, and therefore (unlike reference
    ///     types) are immutable.
    /// </summary>
    public struct DateValue : IValue
    {
        ...
        /// </summary>
        public static readonly DateValue Unanswered;

        /// <summary>
        ///     Static (shared) instance of an unanswered DateValue that (if shown in the interview UI) should be protected from
        ///     unintentional modification.
        /// </summary>
        public static readonly DateValue UnansweredLocked;
        ...
        static DateValue()
        {
            Unanswered = new DateValue();
            UnansweredLocked = new DateValue(null, false);
        }
        ...
        {
            return leftOperand.IsAnswered && rightOperand.IsAnswered
                ? new TrueFalseValue(leftOperand.Value < rightOperand.Value)
                : TrueFalseValue.Unanswered;
        }
        ...
        public object ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            switch (conversionType.FullName)
            {
                ...
                case "HotDocs.Sdk.DateValue":
                    return IsAnswered ? new DateValue(ToDateTime(provider)) : Unanswered;
