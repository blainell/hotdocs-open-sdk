...
namespace HotDocs.Sdk
{
    ...
    public class PackagePathTemplateLocation : PackageTemplateLocation
    {
        ...
        public PackagePathTemplateLocation(string packageID, string packagePath) : base(packageID)
        {
            ...
            _templateDir = Path.Combine(Path.GetDirectoryName(packagePath),
                Path.GetFileNameWithoutExtension(packagePath) + ".dir");
        ...
        {
            const int prime = 397;
            var result = PackagePath.ToLower().GetHashCode(); // package path must be case-insensitive
        ...
        /// </summary>
        /// <param name="force">
        ///     If true, the directory is overwritten. Otherwise, the directory
        ///     is created and files extracted only if the directory does not exist. If force is true
        ///     all previously existing directory content is destroyed.
        /// </param>
        ...
        {
            var location = new PackagePathTemplateLocation(PackageID, PackagePath);
        ...
        /// <summary>
        ///     Returns the folder that the package content was extracted to. Overrides
        ///     <see cref="TemplateLocation.GetTemplateDirectory" />.
        /// </summary>
        /// <returns></returns>
