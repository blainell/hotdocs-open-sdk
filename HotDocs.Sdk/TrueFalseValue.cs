...
{
    /// <summary>
    ///     The TrueFalseValue struct is used to represent boolean (true/false) values in HotDocs. Since it's a struct,
    ///     TrueFalseValue is a value type
    ///     with value semantics. Instances of TrueFalseValue directly contain a boolean value, and therefore (unlike reference
    ///     types) are immutable.
    /// </summary>
    public struct TrueFalseValue : IValue, IComparable
    {
        ...
        /// </summary>
        public static readonly TrueFalseValue Unanswered;

        /// <summary>
        ///     Static (shared) instance of an unanswered TrueFalseValue that would be protected from unintentional modification in
        ///     the interview UI.
        /// </summary>
        public static readonly TrueFalseValue UnansweredLocked;

        /// <summary>
        ///     Static (shared) instance of the True value.
        /// </summary>
        public static readonly TrueFalseValue True;

        /// <summary>
        ///     Static (shared) instance of the False value.
        /// </summary>
        public static readonly TrueFalseValue False;
        ...
        {
            Unanswered = new TrueFalseValue();
            UnansweredLocked = new TrueFalseValue(null, false);
            True = new TrueFalseValue(true);
            False = new TrueFalseValue(false);
        }
        ...
        public static TrueFalseValue operator !(TrueFalseValue operand)
        {
            return operand.IsAnswered
                ? new TrueFalseValue(!operand.Value)
                : Unanswered;
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            if (IsAnswered)
                writer.WriteString(XmlConvert.ToString(_value.Value));
            else
    ...
    /// <returns>A string representation of the value.</returns>
        ...
        public object ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            switch (conversionType.FullName)
            {
                ...
                case "HotDocs.Sdk.TrueFalseValue":
                    return IsAnswered ? new TrueFalseValue(ToBoolean(provider)) : Unanswered;
        ...
        public int CompareTo(object obj)
        {
            ...
            var trueFalseValue = (TrueFalseValue) obj;
