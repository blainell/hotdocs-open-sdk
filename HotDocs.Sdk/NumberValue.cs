...
namespace HotDocs.Sdk
{
	...
	public struct NumberValue : IValue, IComparable
	{
		...
		/// </summary>
		public readonly static NumberValue Unanswered;
		/// <summary>
		/// Static (shared) instance of an unanswered NumberValue that would be protected from unintentional modification in the interview UI.
		/// </summary>
		public readonly static NumberValue UnansweredLocked;
