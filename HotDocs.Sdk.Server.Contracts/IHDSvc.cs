...
namespace HotDocs.Sdk.Server.Contracts
{
    ...
    public interface IHDSvc
    {
        ...
        ///     is essentially the same as what is found in the .HVC file created when you publish a template for use with HotDocs
        ///     Server,
        ///     and the dialog information is a list of the dialog's variables and any answer source mappings that may exist for
        ///     the dialog.
        /// </summary>
        /// <param name="templateID">The file name of the template.</param>
        /// <param name="includeDialogs">
        ///     This indicates whether or not the returned data should include information about dialogs
        ///     and their contents.
        /// </param>
        /// <returns>
        ///     A <c>ComponentInfo</c> object with information about each variable (and optionally dialog) in the template's
        ///     interview.
        /// </returns>
        [OperationContract]
		...
		*/
        ...
        [OperationContract]
        BinaryObject[] GetInterview(string templateID, BinaryObject[] answers, InterviewFormat format,
        ...
        /// </summary>
        /// <remarks>
        ///     This is necessary to facilitate Silverlight interviews working over web services. Callers must specify EITHER
        ///     a templateID (which refers to a template file in the default template directory) OR a templateName and
        ///     templateState.
        /// </remarks>
        /// <param name="templateID">
        ///     The file name and extension for the template.  Caller should pass templateID or a
        ///     templateState, but not both.
        /// </param>
        /// <param name="templateName">
        ///     The name of the template whose interview definition is being requested.  Unnecessary if you
        ///     have specified templateID.
        /// </param>
        /// <param name="format">
        ///     Indicates the format whether to request a Silverlight or JavaScript interview definition.
        ///     The only format currently supported is Silverlight, which means this web service will return a
        ///     compiled Silverlight interview DLL.
        /// </param>
        /// <param name="templateState">
        ///     An encrypted string (originating from a browser interview) identifying a template. Caller
        ///     should pass templateID or templateState, but not both.
        /// </param>
        /// <returns>A <c>BinaryObject</c> with the requested interview definition.</returns>
        [OperationContract]
        BinaryObject GetInterviewDefinition(string templateID, string templateName, InterviewFormat format,
            string templateState);

        /// <summary>
        ///     This web service returns a <c>BinaryObject</c> containing an answer collection created by successively overlaying
        ///     each of the
        ...
        /// <param name="answers">
        ///     An array of answer collections. Each element in this array can be either an XML answer collection
        ///     or an encoded answer set as posted from a browser interview.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        ///     For many template types, HotDocs Server supports multiple output formats,
        ///     and you can use one call to this web service to receive the same document in multiple formats.
        /// </remarks>
        /// <param name="templateID">The file name (not including the path) of the template to assemble.</param>
        /// <param name="answers">
        ///     An array of answer collections to be used to assemble the document.
        ///     If more than one answer collection is included, they are successively overlaid on top of each other before
        ///     assembly.
        ///     Each element in this array can be either an XML answer collection or an encoded answer set as posted from a browser
        ///     interview.
        /// </param>
        /// <param name="format">
        ///     This parameter determines the document format(s) to be delivered.
        ///     It can be one or more compatible values from the <c>OutputFormat</c> enumeration.
        /// </param>
        /// <param name="options">One or more compatible values from the <c>AssemblyOptions</c> enumeration.</param>
        /// <param name="templateState">
        ///     This parameter is either null if the template is located in the web service's default template
        ///     directory (as specified in web.config), or it is an encrypted value encapsulating the location of the template.
        /// </param>
        /// <returns>
        ///     An <c>AssemblyResult</c> object containing the assembled document in the requested output format(s),
        ///     the resulting answer file (if requested), and information about unanswered variables and the assembly queue.
        /// </returns>
        [OperationContract]
        AssemblyResult AssembleDocument(string templateID, BinaryObject[] answers, OutputFormat format,
        ...
        /// </summary>
        /// <remarks>
        ///     Usually, a manifest is built on the desktop with HotDocs Developer when publishing a template. When a template
        ///     is installed on a server without a manifest, this function may be called to build the manifest. HotDocsServer will
        ///     build and cache the JavaScript or Silverlight interview files upon first use. BuildSupportFiles may be used to
        ///     prebuild the interview files so that they are already in the cache the first time they are requested.
        /// </remarks>
        /// <param name="templateID">The file name (not including the path) of the template to assemble.</param>
