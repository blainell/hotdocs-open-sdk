...
namespace HotDocs.Sdk.Server.Contracts
{
    ...
    public enum OutputFormat
    {
        ...
        ///     No output
        /// </summary>
        [EnumMember] None = 0x0000,

        /// <summary>
        ///     <para>XML Answer File</para>
        ///     <para>
        ///         Note: An XML answer file returned from a call to AssembleDocument does not
        ...
        ///         prior to being returned from AssembleDocument.
        ///     </para>
        /// </summary>
        [EnumMember] Answers = 0x0001,
        ...
        ///     </list>
        /// </summary>
        [EnumMember] Native = 0x0002,

        /// <summary>
        ///     A PDF document. (Only supported with RTF/DOCX and HPT templates.)
        /// </summary>
        [EnumMember] PDF = 0x0004,

        /// <summary>
        ///     An HTML version of the assembled document. (Only supported with RTF/DOCX templates.)
        /// </summary>
        [EnumMember] HTML = 0x0008,

        /// <summary>
        ///     A plain text version of the assembled document. (Only supported with RTF/DOCX templates.)
        /// </summary>
        [EnumMember] PlainText = 0x0010,

        /// <summary>
        ///     An HTML version of the assembled document where all images are encoded and included in-line in Data URIs. (Only
        ///     supported with RTF/DOCX templates.)
        /// </summary>
        [EnumMember] HTMLwDataURIs = 0x0020, // see http://en.wikipedia.org/wiki/Data_URI_scheme

        /// <summary>
        ///     An MHTML version of the assembled document where all images are packaged along with the HTML. (Only supported with
        ///     RTF/DOCX templates.)
        /// </summary>
        [EnumMember] MHTML = 0x0040, // see http://en.wikipedia.org/wiki/Mhtml

        /// <summary>
        ///     A Microsoft Word RTF document.
        /// </summary>
        [EnumMember] RTF = 0x0080,

        /// <summary>
        ///     A Microsoft Word Open XML document.
        /// </summary>
        [EnumMember] DOCX = 0x0100,

        /// <summary>
        ///     A WordPerfect document.  (Not supported in HotDocs Core Services.)
        /// </summary>
        [EnumMember] WPD = 0x0200,

        /// <summary>
        ///     A PDF-based HotDocs form document. (Requires HotDocs Filler to open.)
        /// </summary>
        [EnumMember] HPD = 0x0400,

        /// <summary>
        ///     An Envoy-based HotDocs form document. (Requires HotDocs Filler to open.)
        /// </summary>
        [EnumMember] HFD = 0x0800,

        /// <summary>
        ///     A .JPG image file.  (Placeholder for future implementation.)
        /// </summary>
        [EnumMember] JPEG = 0x1000,

        /// <summary>
        ///     A Portable Network Graphics (.PNG) image file.  (Placeholder for future implementation.)
        /// </summary>
        [EnumMember] PNG = 0x2000
    }
}