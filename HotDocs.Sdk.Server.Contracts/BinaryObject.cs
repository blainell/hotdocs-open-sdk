...
namespace HotDocs.Sdk.Server.Contracts
{
    ...
    public class BinaryObject
    {
        ...
        /// </summary>
        [DataMember(IsRequired = true)] public byte[] Data;

        /// <summary>
        ///     The encoding used for the data.
        /// </summary>
        [DataMember(EmitDefaultValue = false)] public string DataEncoding;
        ...
        /// </summary>
        [DataMember(EmitDefaultValue = false)] public OutputFormat Format;
    }
}